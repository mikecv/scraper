...
fn create_details() -> Details {
    Details {
        ...
        max_help_win_width:         700.0,
        help_win_height:            600.0,
        min_help_win_height:        500.0,
        max_help_win_height:        700.0,

        gps_win_width:              700.0,
        gps_win_min_width:          600.0,
        gps_win_max_width:          800.0,
        gps_win_height:             700.0,
        gps_win_min_height:         600.0,
        gps_win_max_height:         800.0,

        time_series_win_width:      500.0,
        time_series_win_min_width:  475.0,
        time_series_win_max_width:  700.0,
        time_series_win_height:     500.0,
        time_series_win_min_height: 475.0,
        time_series_win_max_height: 700.0,

        changelog_win_width:        300.0,
        changelog_win_height:       400.0,
    }
}
